<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.btn-add').click(function(){
			...
			$('.load-form').load(base_url+'manage/jenis_tarif/add');
		});

		$('.btn-edit').click(function(){
			var uc = $(this).attr('uc');

			$('.load-form').load(base_url+'manage/jenis_tarif/edit', {js_uc : uc});
		...
		$('.page-jenis-tarif a.pagination-ajax').click(function(){
			...
			$('.load-data').load(
									base_url+'manage/jenis_tarif/page',
									{
										js_page 			: page
									}
								);
					...
					<?php foreach($result as $row):?>
						...
						<tr>
							...
							<td>
								...
								<a class="btn btn-danger btn-round btn-sm" href="<?=base_url('manage/jenis_tarif/delete/'.$row->uc)?>" onclick="return confirm('Are you sure want to delete?')"><i class="fas fa-trash"></i></a>
							</td>
						</tr>
