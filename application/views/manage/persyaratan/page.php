					...
					<?php foreach($result as $row):?>
						...
						<tr>
							...
							<td>
								...
								<a class="btn btn-danger btn-round btn-sm" href="<?=base_url('manage/persyaratan/delete/'.$row->uc)?>" onclick="return confirm('Are you sure want to delete?')"><i class="fas fa-trash"></i></a>
							</td>
						</tr>
