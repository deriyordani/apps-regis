...
************************************************************************************************************/
		...
		var plusNode = './assets/image/dhtmlgoodies_plus.gif';
		var minusNode = './assets/image/dhtmlgoodies_minus.gif';
	...
	*/
	...
	function addToArray($id,$name,$parentID,$url="",$target="",$icon="./assets/image/dhtmlgoodies_folder.gif", $onclick = ''){
	...
	function addToArrayAss($element){
		...
		$element['icon'] = isset($element['icon']) ? $element['icon'] : './assets/image/dhtmlgoodies_folder.gif';
	...
	function drawSubNode($parentID){
		if(isset($this->elementArray[$parentID])){
			...
			for($no=0;$no<count($this->elementArray[$parentID]);$no++){
				...
				echo "<img class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no]['id']."\" src=\"./assets/image/dhtmlgoodies_plus.gif\"><img src=\"".$this->elementArray[$parentID][$no]['icon']."\">";
	...
	function drawTree(){
		...
		for($no=0;$no<count($this->elementArray[0]);$no++){
			...
			echo "<img id=\"plusMinus".$this->elementArray[0][$no]['id']."\" class=\"tree_plusminus\" src=\"./assets/image/dhtmlgoodies_plus.gif\">";
