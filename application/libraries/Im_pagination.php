...
class Im_pagination{
	...
	function render_ajax($params, $filter = NULL, $like = NULL){
		...
		if ($total_record > 0) {
			...
			if($page_number != 1){
				$html .= "<li class='page-item'><a title='1' class='page-link pagination-ajax' href='#'>First</a></li>";
			}
			else {
				$html .= "<li class='page-item disabled'><a title='1' class='page-link pagination-ajax' href='#'>First</a></li>";
			}
			...
			if($prev_page >= 1){
				...
				$html .= "<a class='page-link pagination-ajax' title='".($page_number - 1)."' href='#'>Prev</a>";
			}
			else{
				$html .= "<li class='page-item disabled'>";
				$html .= "<a class='page-link pagination-ajax' href='#'>Prev</a>";
			}
			...
			for($i = $first_page; $i <= $last_page; $i++){
				...
				$html .= "<a class='page-link pagination-ajax' title='".$i."' href='#'>".$i."</a></li>";
				$html .= "</li>";
			}
			...
			if($next_page <= $total_page){
				$html .= "<li class='page-item'>";
				$html .= "<a class='page-link pagination-ajax' title='".($page_number + 1)."' href='#'>Next</a>";
			}
			else{
				$html .= "<li class='page-item disabled'>";
				$html .= "<a class='page-link pagination-ajax' href='#'>Next</a>";
			}
			$html .= "</li>";
			...
			if($page_number != $total_page){
				$html .= "<li class='page-item'>";
				$html .= "<a class='page-link pagination-ajax' title='".$total_page."' href='#'>Last</a>";
			}
			else{
				$html .= "<li class='page-item disabled'>";
				$html .= "<a class='page-link pagination-ajax' href='#'>Last</a>";
			}
			$html .= "</li>";
